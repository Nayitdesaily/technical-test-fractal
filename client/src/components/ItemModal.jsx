...
import { addItemInOrderThunk, updateItemInOrderThunk } from "../features/orders/orderSlice";

export default function ItemModal({ root, id, item, product }) {
    ...
    <div className="w-full h-screen flex justify-center items-center z-10 bg-[black]/40 fixed top-0 right-0">
      <div
        ...
        <form onSubmit={submit}
          ...
          <button type="submit" className="bg-blue-600 border-[black] boder-2 py-2 px-5 
          font-medium rounded-md text-lg hover:bg-[transparent]">
             Add
          </button>
        </form>
